...
//
//class GraphQLEntityContainer(vararg entities: GQLE<*, *>) {
//
//    val entities: Array<GraphQLClass<*, *>>
//
//    init {
...
//
//    companion object {
//        fun typeName(entityClass: EntityClass<*, *>) = "${entityClass.table.tableName.toLowerCase()}_${entityClass.hashCode()}"
